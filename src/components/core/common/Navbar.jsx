...
function Navbar(props){
    ...
    //        console.log("Printing catalog list :" , result)
                    ...
                    <li key={index}>
                    {
                        link.title === "Catalog" ? (
                            ...
                            translate-x-[-50%] translate-y-[20%] top-[50%] flex flex-col rounded-md bg-richblack-5 p-4 text-richblack-900 opacity-0 transition-all duration-200 group-hover:visible group-hover:opacity-100 lg:w-[300px] z-10'>
                                ...
                                <div className='absolute top-[0] left-[50%] h-6 w-6 rotate-45 rounded bg-richblack-5 translate-y-[-25%] '></div>
                                    ...
                                    subLinks.length ? (
                                        subLinks.map( (subLink ,index) => (
                                             <Link to={subLink?.link} key={index}>
                                                      <p className='w-[90%] text-richblack-900 font-semibold py-2 border-b border-b-richblack-900 mx-auto'>{subLink.title}</p>  
                                             </Link>
                                        ))
                                    ) : 
                                     (<div></div>)
